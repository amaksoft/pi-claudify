...
export function createInspectionGroupPolicy(runtime: InspectionGroupRuntime): InspectionGroupPolicy {
	return {
		...
		onPointerExpand: runtime.onPointerExpand,
...
export function ensureInspectionGroups(container: unknown, runtime: InspectionGroupRuntime, width?: number): void {
	reconcileInspectionGroups(container, createInspectionGroupPolicy(runtime), undefined, width);
}
