...
export function computeToolBackgroundMode(): ToolBackgroundMode {
	...
	// `toolBackground: false` always reverts to pi's native tool-status
	// backgrounds, even overriding a live picker preview.
	if (!settingsFeatureEnabled(settings, "toolBackground")) return "default";
